...
class TAG:
    ...
    TAG_PINNS_STATUS = 'pinns_status'
    TAG_U_VALUE = 'u_component_value'
    TAG_V_VALUE = 'v_component_value'
    TAG_P_VALUE = 'pressure_value'

    TAG_X_VALUE = 'x_sensor_value'
    TAG_Y_VALUE = 'y_sensor_value'
    TAG_T_VALUE = 'time_value'
    ...
    TAG_LIST = {
        ...
        TAG_PINNS_STATUS:             {'id': 19, 'plc': 3, 'type': 'output', 'fault': 0.0, 'default': 0},
        TAG_U_VALUE:  {'id': 13, 'plc': 3, 'type': 'output', 'fault': 0.0, 'default': 0.0},
        TAG_V_VALUE:  {'id': 14, 'plc': 3, 'type': 'output', 'fault': 0.0, 'default': 0.0},
        TAG_P_VALUE:  {'id': 15, 'plc': 3, 'type': 'output', 'fault': 0.0, 'default': 0.0},

        TAG_X_VALUE:  {'id': 16, 'plc': 3, 'type': 'input', 'fault': 0.0, 'default': 0.0},
        TAG_Y_VALUE:  {'id': 17, 'plc': 3, 'type': 'input', 'fault': 0.0, 'default': 0.0},
        TAG_T_VALUE:  {'id': 18, 'plc': 3, 'type': 'input', 'fault': 0.0, 'default': 0.0},
    }
